...
TEST_CASE ( "MIPS32_instr: disasm CP1 instructions")
{
    ...
    CHECK(MIPS32Instr(0x46011831).get_disasm() == "c.un.s $f3, $f1");
    CHECK(MIPS32Instr(0x46211832).get_disasm() == "c.eq.d $f3, $f1");
    CHECK(MIPS32Instr(0x46011832).get_disasm() == "c.eq.s $f3, $f1");
    CHECK(MIPS32Instr(0x46211833).get_disasm() == "c.ueq.d $f3, $f1");
    CHECK(MIPS32Instr(0x46011833).get_disasm() == "c.ueq.s $f3, $f1");
    CHECK(MIPS32Instr(0x46211834).get_disasm() == "c.olt.d $f3, $f1");
    CHECK(MIPS32Instr(0x46011834).get_disasm() == "c.olt.s $f3, $f1");
    CHECK(MIPS32Instr(0x46211835).get_disasm() == "c.ult.d $f3, $f1");
    CHECK(MIPS32Instr(0x46011835).get_disasm() == "c.ult.s $f3, $f1");
    CHECK(MIPS32Instr(0x46211836).get_disasm() == "c.ole.d $f3, $f1");
    CHECK(MIPS32Instr(0x46011836).get_disasm() == "c.ole.s $f3, $f1");
    CHECK(MIPS32Instr(0x46211837).get_disasm() == "c.ule.d $f3, $f1");
    CHECK(MIPS32Instr(0x46011837).get_disasm() == "c.ule.s $f3, $f1");
    CHECK(MIPS32Instr(0x46211838).get_disasm() == "c.sf.d $f3, $f1");
    CHECK(MIPS32Instr(0x46011838).get_disasm() == "c.sf.s $f3, $f1");
    CHECK(MIPS32Instr(0x46211839).get_disasm() == "c.ngle.d $f3, $f1");
    CHECK(MIPS32Instr(0x46011839).get_disasm() == "c.ngle.s $f3, $f1");
    CHECK(MIPS32Instr(0x4621183a).get_disasm() == "c.seq.d $f3, $f1");
    CHECK(MIPS32Instr(0x4601183a).get_disasm() == "c.seq.s $f3, $f1");
    CHECK(MIPS32Instr(0x4621183b).get_disasm() == "c.ngl.d $f3, $f1");
    CHECK(MIPS32Instr(0x4601183b).get_disasm() == "c.ngl.s $f3, $f1");
    CHECK(MIPS32Instr(0x4621183c).get_disasm() == "c.lt.d $f3, $f1");
    CHECK(MIPS32Instr(0x4601183c).get_disasm() == "c.lt.s $f3, $f1");
    CHECK(MIPS32Instr(0x4621183d).get_disasm() == "c.nge.d $f3, $f1");
    CHECK(MIPS32Instr(0x4601183d).get_disasm() == "c.nge.s $f3, $f1");
    CHECK(MIPS32Instr(0x4621183e).get_disasm() == "c.le.d $f3, $f1");
    CHECK(MIPS32Instr(0x4601183e).get_disasm() == "c.le.s $f3, $f1");
    CHECK(MIPS32Instr(0x4621183f).get_disasm() == "c.ngt.d $f3, $f1");
    CHECK(MIPS32Instr(0x4601183f).get_disasm() == "c.ngt.s $f3, $f1");
