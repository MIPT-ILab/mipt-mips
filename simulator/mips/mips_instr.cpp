...
const typename MIPSInstr<RegisterUInt>::MapType MIPSInstr<RegisterUInt>::isaMapR =
{
    ...
    // Variable shifts
    //key     name    operation   ms  source1      source2      destination      pointer                       mips version
    {0x4, { "sllv", OUT_R_ARITHM, 0, RegType::RT, RegType::RS, RegType::RD, &MIPSInstr<RegisterUInt>::execute_sllv, 1} },
    //        0x5 reserved
    {0x6, { "srlv", OUT_R_ARITHM, 0, RegType::RT, RegType::RS, RegType::RD, &MIPSInstr<RegisterUInt>::execute_srlv<uint32>, 1} },
    {0x7, { "srav", OUT_R_ARITHM, 0, RegType::RT, RegType::RS, RegType::RD, &MIPSInstr<RegisterUInt>::execute_srav<uint32>, 1} },

    // Indirect branches
    //key     name    operation  ms  source1      source2      destination      pointer                           mips version
    {0x8, { "jr"  , OUT_R_JUMP, 0, RegType::RS, RegType::ZERO, RegType::ZERO, &MIPSInstr<RegisterUInt>::execute_jr,   1} },
    {0x9, { "jalr", OUT_R_JUMP, 0, RegType::RS, RegType::ZERO, RegType::RD,   &MIPSInstr<RegisterUInt>::execute_jalr, 1} },
    ...
    //key     name    operation  ms     source1       source2   destination       pointer                             mips version
    {0x14, { "dsllv", OUT_R_ARITHM, 0, RegType::RT, RegType::RS, RegType::RD, &MIPSInstr<RegisterUInt>::execute_dsllv,        4} },
    {0x16, { "dsrlv", OUT_R_ARITHM, 0, RegType::RT, RegType::RS, RegType::RD, &MIPSInstr<RegisterUInt>::execute_srlv<uint64>, 4} },
    {0x17, { "dsrav", OUT_R_ARITHM, 0, RegType::RT, RegType::RS, RegType::RD, &MIPSInstr<RegisterUInt>::execute_srav<uint64>, 4} },

    // Multiplication/Division
    //key     name    operation  ms     source1       source2        destination       pointer                                       mips version
    {0x18, { "mult",  OUT_R_ARITHM, 0, RegType::RS, RegType::RT, RegType::HI_LO, &MIPSInstr<RegisterUInt>::execute_multiplication<int32>,  1} },
    {0x19, { "multu", OUT_R_ARITHM, 0, RegType::RS, RegType::RT, RegType::HI_LO, &MIPSInstr<RegisterUInt>::execute_multiplication<uint32>, 1} },
    {0x1A, { "div",   OUT_R_ARITHM, 0, RegType::RS, RegType::RT, RegType::HI_LO, &MIPSInstr<RegisterUInt>::execute_division<int32>,        1} },
    {0x1B, { "divu",  OUT_R_ARITHM, 0, RegType::RS, RegType::RT, RegType::HI_LO, &MIPSInstr<RegisterUInt>::execute_division<uint32>,       1} },
    {0x1C, { "dmult", OUT_R_ARITHM, 0, RegType::RS, RegType::RT, RegType::HI_LO, &MIPSInstr<RegisterUInt>::execute_multiplication<int64>,  3} },
    {0x1D, { "dmultu",OUT_R_ARITHM, 0, RegType::RS, RegType::RT, RegType::HI_LO, &MIPSInstr<RegisterUInt>::execute_multiplication<uint64>, 3} },
    {0x1E, { "ddiv",  OUT_R_ARITHM, 0, RegType::RS, RegType::RT, RegType::HI_LO, &MIPSInstr<RegisterUInt>::execute_division<int64>,        3} },
    {0x1F, { "ddivu", OUT_R_ARITHM, 0, RegType::RS, RegType::RT, RegType::HI_LO, &MIPSInstr<RegisterUInt>::execute_division<uint64>,       3} },
...
// ********************** REGIMM INSTRUCTIONS *************************
    ...
    // Linking branches
    //key     name    operation   memsize     source1        source2      destination      pointer                                                             mips version
    {0x10, { "bltzal",  OUT_RI_BRANCH_0, 0, RegType::RS, RegType::ZERO, RegType::RA, &MIPSInstr<RegisterUInt>::execute_branch_and_link<&MIPSInstr<RegisterUInt>::ltz>, 1} },
    {0x11, { "bgezal",  OUT_RI_BRANCH_0, 0, RegType::RS, RegType::ZERO, RegType::RA, &MIPSInstr<RegisterUInt>::execute_branch_and_link<&MIPSInstr<RegisterUInt>::gez>, 1} },
    {0x12, { "bltzall", OUT_RI_BRANCH_0, 0, RegType::RS, RegType::ZERO, RegType::RA, &MIPSInstr<RegisterUInt>::execute_branch_and_link<&MIPSInstr<RegisterUInt>::ltz>, 2} },
    {0x13, { "bgezall", OUT_RI_BRANCH_0, 0, RegType::RS, RegType::ZERO, RegType::RA, &MIPSInstr<RegisterUInt>::execute_branch_and_link<&MIPSInstr<RegisterUInt>::gez>, 2} }
};
...
const typename MIPSInstr<RegisterUInt>::MapType MIPSInstr<RegisterUInt>::isaMapIJ =
{
    ...
    {0x3, { "jal", OUT_J_JUMP, 0, RegType::ZERO, RegType::ZERO, RegType::RA,   &MIPSInstr<RegisterUInt>::execute_jal,  1 } },
    ...
    {0x6, { "blez", OUT_RI_BRANCH_0, 0, RegType::RS, RegType::ZERO, RegType::ZERO, &MIPSInstr<RegisterUInt>::execute_branch<&MIPSInstr<RegisterUInt>::lez>, 1} },
    {0x7, { "bgtz", OUT_RI_BRANCH_0, 0, RegType::RS, RegType::ZERO, RegType::ZERO, &MIPSInstr<RegisterUInt>::execute_branch<&MIPSInstr<RegisterUInt>::gtz>, 1} },
    ...
    {0x16, { "blezl", OUT_RI_BRANCH_0, 0, RegType::RS, RegType::RT,   RegType::ZERO, &MIPSInstr<RegisterUInt>::execute_branch<&MIPSInstr<RegisterUInt>::lez>, 2} },
    {0x17, { "bgtzl", OUT_RI_BRANCH_0, 0, RegType::RS, RegType::RT,   RegType::ZERO, &MIPSInstr<RegisterUInt>::execute_branch<&MIPSInstr<RegisterUInt>::gtz>, 2} },
...
const typename MIPSInstr<RegisterUInt>::MapType MIPSInstr<RegisterUInt>::isaMapMIPS32 =
{
    ...
    //key     name    operation  memsize    source1      source2      destination      pointer                       mips version
    {0x20, { "clz",   OUT_R_ARITHM, 0, RegType::RS, RegType::ZERO, RegType::RD, &MIPSInstr<RegisterUInt>::execute_clz,     32} },
    {0x21, { "clo",   OUT_R_ARITHM, 0, RegType::RS, RegType::ZERO, RegType::RD, &MIPSInstr<RegisterUInt>::execute_clo,     32} },
    {0x24, { "dclz",  OUT_R_ARITHM, 0, RegType::RS, RegType::ZERO, RegType::RD, &MIPSInstr<RegisterUInt>::execute_dclz,    64} },
    {0x25, { "dclo",  OUT_R_ARITHM, 0, RegType::RS, RegType::ZERO, RegType::RD, &MIPSInstr<RegisterUInt>::execute_dclo,    64} }
};
