...
template<typename I> const auto mips_add     = ALU::addition_overflow<I, uint32>;
template<typename I> const auto mips_addi    = ALU::addition_overflow_imm<I, uint32>;
template<typename I> const auto mips_addiu   = ALU::addition_imm<I, uint32>;
template<typename I> const auto mips_addu    = ALU::addition<I, uint32>;
template<typename I> const auto mips_and     = ALU::andv<I>;
template<typename I> const auto mips_andi    = ALU::andi<I>;
template<typename I> const auto mips_beq     = ALU::branch<I, ALU::eq<I>>;
template<typename I> const auto mips_beql    = ALU::branch<I, ALU::eq<I>>;
template<typename I> const auto mips_bgez    = ALU::branch<I, ALU::gez<I>>;
template<typename I> const auto mips_bgezal  = ALU::branch_and_link<I, ALU::gez<I>>;
template<typename I> const auto mips_bgezall = ALU::branch_and_link<I, ALU::gez<I>>;
template<typename I> const auto mips_bgezl   = ALU::branch<I, ALU::gez<I>>;
template<typename I> const auto mips_bgtz    = ALU::branch<I, ALU::gtz<I>>;
template<typename I> const auto mips_bgtzl   = ALU::branch<I, ALU::gtz<I>>;
template<typename I> const auto mips_blez    = ALU::branch<I, ALU::lez<I>>;
template<typename I> const auto mips_blezl   = ALU::branch<I, ALU::lez<I>>;
template<typename I> const auto mips_bltz    = ALU::branch<I, ALU::ltz<I>>;
template<typename I> const auto mips_bltzal  = ALU::branch_and_link<I, ALU::ltz<I>>;
template<typename I> const auto mips_bltzall = ALU::branch_and_link<I, ALU::ltz<I>>;
template<typename I> const auto mips_bltzl   = ALU::branch<I, ALU::ltz<I>>;
template<typename I> const auto mips_bne     = ALU::branch<I, ALU::ne<I>>;
template<typename I> const auto mips_bnel    = ALU::branch<I, ALU::ne<I>>;
template<typename I> const auto mips_break   = ALU::breakpoint<I>;
template<typename I> const auto mips_clo     = ALU::clo<I, uint32>;
template<typename I> const auto mips_clz     = ALU::clz<I, uint32>;
template<typename I> const auto mips_dadd    = ALU::addition_overflow<I, uint64>;
template<typename I> const auto mips_daddi   = ALU::addition_overflow_imm<I, uint64>;
template<typename I> const auto mips_daddiu  = ALU::addition_imm<I, uint64>;
template<typename I> const auto mips_daddu   = ALU::addition<I, uint64>;
template<typename I> const auto mips_dclo    = ALU::clo<I, uint64>;
template<typename I> const auto mips_dclz    = ALU::clz<I, uint64>;
template<typename I> const auto mips_dsll    = ALU::sll<I, uint64>;
template<typename I> const auto mips_dsll32  = ALU::dsll32<I>;
template<typename I> const auto mips_dsllv   = ALU::sllv<I, uint64>;
template<typename I> const auto mips_dsra    = ALU::sra<I, uint64>;
template<typename I> const auto mips_dsra32  = ALU::dsra32<I>;
template<typename I> const auto mips_dsrav   = ALU::srav<I, uint64>;
template<typename I> const auto mips_dsrl    = ALU::srl<I, uint64>;
template<typename I> const auto mips_dsrl32  = ALU::dsrl32<I>;
template<typename I> const auto mips_dsrlv   = ALU::srlv<I, uint64>;
template<typename I> const auto mips_dsub    = ALU::subtraction_overflow<I, uint64>;
template<typename I> const auto mips_dsubu   = ALU::subtraction<I, uint64>;
template<typename I> const auto mips_eret    = ALU::eret<I>;
template<typename I> const auto mips_j       = ALU::j<I>;
template<typename I> const auto mips_jal     = ALU::jump_and_link<I, ALU::j<I>>;
template<typename I> const auto mips_jalr    = ALU::jump_and_link<I, ALU::jr<I>>;
template<typename I> const auto mips_jr      = ALU::jr<I>;
template<typename I> const auto mips_lb      = ALU::load_addr<I>;
template<typename I> const auto mips_lbu     = ALU::load_addr<I>;
template<typename I> const auto mips_ld      = ALU::load_addr_aligned<I>;
template<typename I> const auto mips_ldl     = ALU::load_addr<I>;
template<typename I> const auto mips_ldr     = ALU::load_addr<I>;
template<typename I> const auto mips_lh      = ALU::load_addr_aligned<I>;
template<typename I> const auto mips_lhu     = ALU::load_addr_aligned<I>;
template<typename I> const auto mips_ll      = ALU::load_addr_aligned<I>;
template<typename I> const auto mips_lui     = ALU::upper_immediate<I, 16>;
template<typename I> const auto mips_lw      = ALU::load_addr_aligned<I>;
template<typename I> const auto mips_lwl     = ALU::load_addr_left32<I>;
template<typename I> const auto mips_lwr     = ALU::load_addr_right32<I>;
template<typename I> const auto mips_lwu     = ALU::load_addr_aligned<I>;
template<typename I> const auto mips_mfc0    = ALU::move<I>;
template<typename I> const auto mips_mfhi    = ALU::move<I>;
template<typename I> const auto mips_mflo    = ALU::move<I>;
template<typename I> const auto mips_movn    = ALU::movn<I>;
template<typename I> const auto mips_movz    = ALU::movz<I>;
template<typename I> const auto mips_mtc0    = ALU::move<I>;
template<typename I> const auto mips_mthi    = ALU::move<I>;
template<typename I> const auto mips_mtlo    = ALU::move<I>;
template<typename I> const auto mips_nor     = ALU::nor<I>;
template<typename I> const auto mips_or      = ALU::orv<I>;
template<typename I> const auto mips_ori     = ALU::ori<I>;
template<typename I> const auto mips_sb      = ALU::store_addr<I>;
template<typename I> const auto mips_sc      = ALU::store_addr_aligned<I>;
template<typename I> const auto mips_sd      = ALU::store_addr_aligned<I>;
template<typename I> const auto mips_sdl     = ALU::store_addr<I>;
template<typename I> const auto mips_sdr     = ALU::store_addr<I>;
template<typename I> const auto mips_sh      = ALU::store_addr_aligned<I>;
template<typename I> const auto mips_sll     = ALU::sll<I, uint32>;
template<typename I> const auto mips_sllv    = ALU::sllv<I, uint32>;
template<typename I> const auto mips_slt     = ALU::set<I, ALU::lt<I>>;
template<typename I> const auto mips_slti    = ALU::set<I, ALU::lti<I>>;
template<typename I> const auto mips_sltiu   = ALU::set<I, ALU::ltiu<I>>;
template<typename I> const auto mips_sltu    = ALU::set<I, ALU::ltu<I>>;
template<typename I> const auto mips_sra     = ALU::sra<I, uint32>;
template<typename I> const auto mips_srav    = ALU::srav<I, uint32>;
template<typename I> const auto mips_srl     = ALU::srl<I, uint32>;
template<typename I> const auto mips_srlv    = ALU::srlv<I, uint32>;
template<typename I> const auto mips_sub     = ALU::subtraction_overflow<I, uint32>;
template<typename I> const auto mips_subu    = ALU::subtraction<I, uint32>;
template<typename I> const auto mips_sw      = ALU::store_addr_aligned<I>;
template<typename I> const auto mips_swl     = ALU::store_addr_left32<I>;
template<typename I> const auto mips_swr     = ALU::store_addr_right32<I>;
template<typename I> const auto mips_syscall = ALU::syscall<I>;
template<typename I> const auto mips_teq     = ALU::trap<I, ALU::eq<I>>;
template<typename I> const auto mips_teqi    = ALU::trap<I, ALU::eqi<I>>;
template<typename I> const auto mips_tge     = ALU::trap<I, ALU::ge<I>>;
template<typename I> const auto mips_tgei    = ALU::trap<I, ALU::gei<I>>;
template<typename I> const auto mips_tgeiu   = ALU::trap<I, ALU::geiu<I>>;
template<typename I> const auto mips_tgeu    = ALU::trap<I, ALU::geu<I>>;
template<typename I> const auto mips_tlt     = ALU::trap<I, ALU::lt<I>>;
template<typename I> const auto mips_tlti    = ALU::trap<I, ALU::lti<I>>;
template<typename I> const auto mips_tltiu   = ALU::trap<I, ALU::ltiu<I>>;
template<typename I> const auto mips_tltu    = ALU::trap<I, ALU::ltu<I>>;
template<typename I> const auto mips_tne     = ALU::trap<I, ALU::ne<I>>;
template<typename I> const auto mips_tnei    = ALU::trap<I, ALU::nei<I>>;
template<typename I> const auto mips_xor     = ALU::xorv<I>;
template<typename I> const auto mips_xori    = ALU::xori<I>;
template<typename I> const auto mips_unknown = ALU::unknown_instruction<I>;
...
// CP1 instructions
template<typename I> const auto mips_abs_d     = ALU::unknown_instruction<I>;
template<typename I> const auto mips_abs_s     = ALU::unknown_instruction<I>;
template<typename I> const auto mips_add_d     = ALU::unknown_instruction<I>;
template<typename I> const auto mips_add_s     = ALU::unknown_instruction<I>;
template<typename I> const auto mips_bc1f      = ALU::unknown_instruction<I>;
template<typename I> const auto mips_bc1t      = ALU::unknown_instruction<I>;
template<typename I> const auto mips_bc1fl      = ALU::unknown_instruction<I>;
template<typename I> const auto mips_bc1tl      = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_f_d     = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_f_s     = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_un_d    = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_un_s    = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_eq_d    = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_eq_s    = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_ueq_d   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_ueq_s   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_olt_d   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_olt_s   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_ult_d   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_ult_s   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_ole_d   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_ole_s   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_ule_d   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_ule_s   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_sf_d    = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_sf_s    = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_ngle_d  = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_ngle_s  = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_seq_d   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_seq_s   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_ngl_d   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_ngl_s   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_lt_d    = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_lt_s    = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_nge_d   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_nge_s   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_le_d    = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_le_s    = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_ngt_d   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_c_ngt_s   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_ceil_l_d  = ALU::unknown_instruction<I>;
template<typename I> const auto mips_ceil_l_s  = ALU::unknown_instruction<I>;
template<typename I> const auto mips_ceil_w_d  = ALU::unknown_instruction<I>;
template<typename I> const auto mips_ceil_w_s  = ALU::unknown_instruction<I>;
template<typename I> const auto mips_cfc1      = ALU::unknown_instruction<I>;
template<typename I> const auto mips_ctc1      = ALU::unknown_instruction<I>;
template<typename I> const auto mips_cvt_d_l   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_cvt_d_s   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_cvt_d_w   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_cvt_s_d   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_cvt_s_l   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_cvt_s_w   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_cvt_l_d   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_cvt_l_s   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_cvt_w_d   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_cvt_w_s   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_div_d     = ALU::unknown_instruction<I>;
template<typename I> const auto mips_div_s     = ALU::unknown_instruction<I>;
template<typename I> const auto mips_dmfc1     = ALU::unknown_instruction<I>;
template<typename I> const auto mips_dmtc1     = ALU::unknown_instruction<I>;
template<typename I> const auto mips_floor_l_d = ALU::unknown_instruction<I>;
template<typename I> const auto mips_floor_l_s = ALU::unknown_instruction<I>;
template<typename I> const auto mips_floor_w_d = ALU::unknown_instruction<I>;
template<typename I> const auto mips_floor_w_s = ALU::unknown_instruction<I>;
template<typename I> const auto mips_ldc1      = ALU::unknown_instruction<I>;
template<typename I> const auto mips_lwc1      = ALU::unknown_instruction<I>;
template<typename I> const auto mips_ldxc1     = ALU::unknown_instruction<I>;
template<typename I> const auto mips_lwxc1     = ALU::unknown_instruction<I>;
template<typename I> const auto mips_mfc1      = ALU::unknown_instruction<I>;
template<typename I> const auto mips_madd_d    = ALU::unknown_instruction<I>;
template<typename I> const auto mips_madd_s    = ALU::unknown_instruction<I>;
template<typename I> const auto mips_mov_d     = ALU::unknown_instruction<I>;
template<typename I> const auto mips_mov_s     = ALU::unknown_instruction<I>;
template<typename I> const auto mips_movf      = ALU::unknown_instruction<I>;
template<typename I> const auto mips_movf_d    = ALU::unknown_instruction<I>;
template<typename I> const auto mips_movf_s    = ALU::unknown_instruction<I>;
template<typename I> const auto mips_movn_d    = ALU::unknown_instruction<I>;
template<typename I> const auto mips_movn_s    = ALU::unknown_instruction<I>;
template<typename I> const auto mips_movt      = ALU::unknown_instruction<I>;
template<typename I> const auto mips_movt_d    = ALU::unknown_instruction<I>;
template<typename I> const auto mips_movt_s    = ALU::unknown_instruction<I>;
template<typename I> const auto mips_movz_d    = ALU::unknown_instruction<I>;
template<typename I> const auto mips_movz_s    = ALU::unknown_instruction<I>;
template<typename I> const auto mips_msub_d    = ALU::unknown_instruction<I>;
template<typename I> const auto mips_msub_s    = ALU::unknown_instruction<I>;
template<typename I> const auto mips_mtc1      = ALU::unknown_instruction<I>;
template<typename I> const auto mips_mul_d     = ALU::unknown_instruction<I>;
template<typename I> const auto mips_mul_s     = ALU::unknown_instruction<I>;
template<typename I> const auto mips_neg_d     = ALU::unknown_instruction<I>;
template<typename I> const auto mips_neg_s     = ALU::unknown_instruction<I>;
template<typename I> const auto mips_nmadd_d   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_nmadd_s   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_nmsub_d   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_nmsub_s   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_recip_d   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_recip_s   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_round_l_d = ALU::unknown_instruction<I>;
template<typename I> const auto mips_round_l_s = ALU::unknown_instruction<I>;
template<typename I> const auto mips_round_w_d = ALU::unknown_instruction<I>;
template<typename I> const auto mips_round_w_s = ALU::unknown_instruction<I>;
template<typename I> const auto mips_rsqrt_d   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_rsqrt_s   = ALU::unknown_instruction<I>;
template<typename I> const auto mips_sdc1      = ALU::unknown_instruction<I>;
template<typename I> const auto mips_sdxc1     = ALU::unknown_instruction<I>;
template<typename I> const auto mips_sqrt_d    = ALU::unknown_instruction<I>;
template<typename I> const auto mips_sqrt_s    = ALU::unknown_instruction<I>;
template<typename I> const auto mips_sub_d     = ALU::unknown_instruction<I>;
template<typename I> const auto mips_sub_s     = ALU::unknown_instruction<I>;
template<typename I> const auto mips_swc1      = ALU::unknown_instruction<I>;
template<typename I> const auto mips_swxc1     = ALU::unknown_instruction<I>;
template<typename I> const auto mips_trunc_l_d = ALU::unknown_instruction<I>;
template<typename I> const auto mips_trunc_l_s = ALU::unknown_instruction<I>;
template<typename I> const auto mips_trunc_w_d = ALU::unknown_instruction<I>;
template<typename I> const auto mips_trunc_w_s = ALU::unknown_instruction<I>;

template<typename I>
struct MIPSTableEntry
{
    std::string_view name = "Unknown instruction";
    ALU::Execute<I> function = mips_unknown<I>;
