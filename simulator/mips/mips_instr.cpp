...
const std::unordered_map <uint8, MIPSInstr::ISAEntry> MIPSInstr::isaMapR =
{
    ...
    //key      name   operation  memsize           pointer   
    {0x14, { "dsllv", OUT_R_SHIFT, 0, &MIPSInstr::execute_dsllv,        3} },
    {0x16, { "dsrlv", OUT_R_SHIFT, 0, &MIPSInstr::execute_srlv<uint64>, 3} },
    {0x17, { "dsrav", OUT_R_SHIFT, 0, &MIPSInstr::execute_srav<uint64>, 3} },
    ...
    // Doubleword multiplication/division
    //key      name    operation  memsize           pointer
    {0x1C, { "dmult", OUT_R_DIVMULT, 0, &MIPSInstr::execute_dmult,   3} },
    {0x1D, { "dmultu",OUT_R_DIVMULT, 0, &MIPSInstr::execute_dmultu,  3} },
    ...
    {0x22, { "sub",  OUT_R_ARITHM, 0, &MIPSInstr::execute_sub<uint32>,  1} },
    ...
    //key      name   operation  memsize           pointer
    {0x2C, { "dadd",  OUT_R_ARITHM, 0, &MIPSInstr::execute_add<int64>,   3} },
    {0x2D, { "daddu", OUT_R_ARITHM, 0, &MIPSInstr::execute_addu<uint64>, 3} },
    {0x2E, { "dsub",  OUT_R_ARITHM, 0, &MIPSInstr::execute_sub<uint64>,  3} },
    {0x2F, { "dsubu", OUT_R_ARITHM, 0, &MIPSInstr::execute_subu<uint64>, 3} },
...
const std::unordered_map <uint8, MIPSInstr::ISAEntry> MIPSInstr::isaMapIJ =
{
    ...
    // Addition/Subtraction
    //key     name  operation  memsize       pointer
    {0x8, { "addi",  OUT_I_ARITHM, 0, &MIPSInstr::execute_addi<int32>,   1} },
    {0x9, { "addiu", OUT_I_ARITHM, 0, &MIPSInstr::execute_addiu<uint32>, 1} },
    ...
    // Unaligned doubleword loads
    //key     name         operation         memsize       pointer
    {0x1A, { "ldl",  OUT_I_PARTIAL_LOAD, 8, &MIPSInstr::calculate_load_addr, 3} },
    {0x1B, { "ldr",  OUT_I_PARTIAL_LOAD, 8, &MIPSInstr::calculate_load_addr, 3} },

    // Doubleword Addition/Subtraction
    //key     name         operation         memsize       pointer
    {0x18, { "daddi",  OUT_I_ARITHM, 0, &MIPSInstr::execute_addi<int64>,   1} },
    {0x19, { "daddiu", OUT_I_ARITHM, 0, &MIPSInstr::execute_addiu<uint64>, 1} },
    ...
    {0x3F, { "sd",  OUT_I_STORE,  8, &MIPSInstr::calculate_store_addr, 3} }
};
...
void MIPSInstr::set_v_dst( uint64 value)
{
    ...
    {
        std::ostringstream oss;
        oss << "\t [ $" << dst << " = 0x" << std::hex << static_cast<uint64>(v_dst);
