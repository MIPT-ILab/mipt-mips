...
for %%G in (infra\cache infra\elf_parser infra\config infra\memory infra\ports infra\string mips mips\mips_register infra\instrcache func_sim bpu core) do (
    echo Testing %%G
    cd %%G\t
