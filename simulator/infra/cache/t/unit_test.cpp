...
{
    auto test_tags = CacheTagArray::create( false,  "always_hit", cache_size, cache_ways, cache_line_size, addr_size_in_bits);
...
{
    auto test_tags = CacheTagArray::create( false,  "infinite", cache_size, cache_ways, cache_line_size, addr_size_in_bits);
...
{
    auto test_tags = CacheTagArray::create( false,  "infinite", cache_size * 4, cache_ways, cache_line_size, addr_size_in_bits);
