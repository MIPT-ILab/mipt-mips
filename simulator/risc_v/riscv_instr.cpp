...
struct RISCVAutogeneratedTableEntry
{
    ...
    bool check_mask( uint32 bytes, uint16 bit_width_supported, uint16 bit_width) const noexcept
    {
        if ( ( bytes & mask) == match)
            switch(bit_width_supported)
            {
                case RV_ANY:     return true;
                case RV32:       return bit_width == 32;
                case RV64:       return bit_width == 64;
                case RV128:      return bit_width == 128;
                case RV32_RV64:  return ( bit_width == 32) || ( bit_width == 64);
                case RV64_RV128: return ( bit_width == 64) || ( bit_width == 128);
            }
        return false;
    }
};
...
static const RISCVAutogeneratedTableEntry instr_c_lqsp = { "c_lqsp", 0x2002, 0xe003};

static const RISCVAutogeneratedTableEntry instr_c_sqsp = { "c_sqsp", 0xa002, 0xe003};

static const RISCVAutogeneratedTableEntry instr_invalid = { "unknown", 0x0, 0xffff };

template<typename I>
static const RISCVTableEntry<I> invalid_instr = {'I', instr_invalid, do_nothing<I>, OUT_ARITHM, ' ', Imm::NO, Src1::ZERO, Src2::ZERO, Dst::ZERO, 0};
...
struct RISCVTableEntry
{
    ...
    Dst  dst;
    uint32 mem_size;
    RISCVBitWidth bit_width = RV_ANY;
...
{
    /*-------------- I --------------*/
    {'I', instr_invalid,do_nothing<I>,     OUT_ARITHM, ' ', Imm::NO,    Src1::ZERO, Src2::ZERO, Dst::ZERO, 0},
    ...
    {'I', instr_addiw,  execute_addiw<I>,  OUT_ARITHM, 'I', Imm::ARITH, Src1::RS1,  Src2::ZERO, Dst::RD,   0, RV64},
    {'I', instr_slliw,  execute_slliw<I>,  OUT_ARITHM, 'I', Imm::ARITH, Src1::RS1,  Src2::ZERO, Dst::RD,   0, RV64},
    {'I', instr_srliw,  execute_srliw<I>,  OUT_ARITHM, 'I', Imm::ARITH, Src1::RS1,  Src2::ZERO, Dst::RD,   0, RV64},
    {'I', instr_sraiw,  execute_sraiw<I>,  OUT_ARITHM, 'I', Imm::ARITH, Src1::RS1,  Src2::ZERO, Dst::RD,   0, RV64},
    ...
    {'I', instr_addw,   execute_addw<I>,   OUT_ARITHM, ' ', Imm::NO,    Src1::RS1,  Src2::RS2,  Dst::RD,   0, RV64},
    {'I', instr_subw,   execute_subw<I>,   OUT_ARITHM, ' ', Imm::NO,    Src1::RS1,  Src2::RS2,  Dst::RD,   0, RV64},
    {'I', instr_sllw,   execute_sllw<I>,   OUT_ARITHM, ' ', Imm::NO,    Src1::RS1,  Src2::RS2,  Dst::RD,   0, RV64},
    {'I', instr_sraw,   execute_sraw<I>,   OUT_ARITHM, ' ', Imm::NO,    Src1::RS1,  Src2::RS2,  Dst::RD,   0, RV64},
    {'I', instr_srlw,   execute_srlw<I>,   OUT_ARITHM, ' ', Imm::NO,    Src1::RS1,  Src2::RS2,  Dst::RD,   0, RV64},
    ...
    {'C', instr_c_bnez,     execute_c_bnez<I>,     OUT_BRANCH, ImmediateType::C_BNEZ,     Imm::ARITH, Src1::RS1_3_BITS, Src2::ZERO,       Dst::ZERO,       0},
    // Loads and stores
    {'C', instr_c_lwsp,     execute_c_lwsp<I>,     OUT_LOAD,   ImmediateType::C_LWSP,     Imm::ADDR,  Src1::SP,         Src2::ZERO,       Dst::RD,         4},
    {'C', instr_c_lw,       execute_c_lw<I>,       OUT_LOAD,   ImmediateType::C_LW,       Imm::ADDR,  Src1::RS1_3_BITS, Src2::ZERO,       Dst::RD_3_BITS,  4},
    ...
    {'C', instr_c_lui,      execute_c_lui<I>,      OUT_ARITHM, ImmediateType::C_LUI,      Imm::LOGIC, Src1::ZERO,       Src2::ZERO,       Dst::RD,         0},
    // Immediate logic and comparison
    ...
    {'C', instr_c_add,      execute_c_add<I>,      OUT_ARITHM, ' ',                       Imm::NO,    Src1::ZERO,       Src2::RS2_COMPR,  Dst::RD,         0},
    // Register-register logic and comparison
    {'C', instr_c_xor,      execute_c_xor<I>,      OUT_ARITHM, ' ',                       Imm::NO,    Src1::ZERO,       Src2::RS2_3_BITS, Dst::RS1_3_BITS, 0},
    {'C', instr_c_or,       execute_c_or<I>,       OUT_ARITHM, ' ',                       Imm::NO,    Src1::ZERO,       Src2::RS2_3_BITS, Dst::RS1_3_BITS, 0},
    {'C', instr_c_and,      execute_c_and<I>,      OUT_ARITHM, ' ',                       Imm::NO,    Src1::ZERO,       Src2::RS2_3_BITS, Dst::RS1_3_BITS, 0},
};

template<typename I>
const auto& find_entry( uint32 bytes, uint16 bit_width)
{
    for (const auto& e : cmd_desc<I>)
        if ( e.entry.check_mask( bytes, e.bit_width, bit_width))
            return e;
