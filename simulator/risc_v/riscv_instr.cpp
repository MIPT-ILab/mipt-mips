...
template<typename I> const auto execute_gorci = ALU::gorci<I, typename I::RegisterUInt>;
...
static const std::vector<RISCVTableEntry<I>> cmd_desc =
{
    ...
    {'B', instr_gorci,      execute_gorci<I>,  OUT_ARITHM, ' ', Imm::ARITH,{ Src::RS1, Src::ZERO }, { Dst::RD }, 0, 32 | 64    },
