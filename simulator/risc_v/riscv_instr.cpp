...
template<typename I> const auto execute_addi   = RISCVALU<I>::riscv_addition_imm;
...
template<typename I> const auto execute_slli   = RISCVALU<I>::sll;
...
template<typename I> const auto execute_srli   = RISCVALU<I>::srl;
...
template<typename I> const auto execute_srai   = RISCVALU<I>::sra;
...
template<typename I> const auto execute_add    = RISCVALU<I>::riscv_addition;
template<typename I> const auto execute_addw   = RISCVALU<I>::template riscv_addition<uint32>;
template<typename I> const auto execute_sub    = RISCVALU<I>::riscv_subtraction;
template<typename I> const auto execute_subw   = RISCVALU<I>::template riscv_subtraction<uint32>;
template<typename I> const auto execute_sll    = RISCVALU<I>::sllv;
...
template<typename I> const auto execute_srl    = RISCVALU<I>::srlv;
template<typename I> const auto execute_srlw   = RISCVALU<I>::template srlv<uint32>;
template<typename I> const auto execute_sra    = RISCVALU<I>::srav;
...
template<typename I> const auto execute_clz    = RISCVALU<I>::clz;
template<typename I> const auto execute_ctz    = RISCVALU<I>::ctz;
template<typename I> const auto execute_gorc   = RISCVALU<I>::gorc;
...
template<typename I> const auto execute_pack   = RISCVALU<I>::pack;
template<typename I> const auto execute_packu  = RISCVALU<I>::packu;
template<typename I> const auto execute_pcnt   = RISCVALU<I>::pcnt;
...
template<typename I> const auto execute_sbext  = RISCVALU<I>::sbext;
template<typename I> const auto execute_sbinv  = RISCVALU<I>::sbinv;
template<typename I> const auto execute_shfl   = RISCVALU<I>::riscv_shfl;
template<typename I> const auto execute_slo    = RISCVALU<I>::slo;
template<typename I> const auto execute_sloi   = RISCVALU<I>::sloi;
template<typename I> const auto execute_sro    = RISCVALU<I>::sro;
...
struct RISCVTableEntry
{
    ...
    RISCVALU<I>::Execute function = do_nothing<I>;
