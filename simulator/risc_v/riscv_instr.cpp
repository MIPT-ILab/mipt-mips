...
static const std::vector<RISCVTableEntry<I>> cmd_desc =
{
    ...
    {'I', instr_ebreak, execute_ebreak<I>, OUT_TRAP,   ' ', Imm::NO,    Src1::ZERO, Src2::ZERO, Dst::ZERO, 0, 32 | 64 | 128}, // NOLINT(hicpp-signed-bitwise) https://bugs.llvm.org/show_bug.cgi?id=44977
