...
struct TestData {
    ...
    void make_test( std::string_view str, uint32 imm)
    {
        ...
        if constexpr ( std::is_same_v<T, uint128>)
            ...
            CHECK( split( instr.get_v_dst()) == split( dst));
        else
...
#define TEST_IMM_OP( no, name, dst, src, imm) \
    TEST_CASE( "RISCV autogenerated test " # name " " # no) { TestData<typename Instr::RegisterUInt>( src, 0, dst).make_test( #name, imm); }
...
#define TEST_RR_OP( no, name, dst, src1, src2) \
    TEST_CASE( "RISCV autogenerated test " # name " " # no) { TestData<typename Instr::RegisterUInt>( src1, src2, dst).make_test( #name, 0); }
...
#define TEST_SRLI(n, v, a) TEST_IMM_OP(n, srli, ((v) & ((1ULL << (bitwidth<Instr::RegisterUInt> - 1) << 1) - 1)) >> (a), v, a)
#define TEST_SRL(n, v, a)  TEST_RR_OP(n,  srl, ((v) & ((1ULL << (bitwidth<Instr::RegisterUInt> - 1) << 1) - 1)) >> (a), v, a)
