...
TEST_CASE("RISCV disassembly")
{
    ...
    TEST_RV32_DISASM  ( 0x60471793,  "sext_b $a3, $a4");  // 0110000 | 00100 | 01110($a4) | 001 | 01111 ($a5) | 0010011
...
TEST_RV32_RR_OP( 1, sext_b, 0x7FFFFF90, 0x00000090, 0) // check for preservence of sign for positive
TEST_RV32_RR_OP( 2, sext_b, 0x7FFFFF90, 0x7FFFFF90, 0) //
TEST_RV32_RR_OP( 5, sext_b, 0x0000007F, 0x0000007F, 0) // 
TEST_RV32_RR_OP( 6, sext_b, 0x0000007F, 0x0FFFFF7F, 0) //
TEST_RV32_RR_OP( 3, sext_b, 0xFFFFFF80, 0xF0000080, 0) // check for preservence of sign for negative
TEST_RV32_RR_OP( 4, sext_b, 0xFFFFFF80, 0xFFFFFF80, 0) //
TEST_RV32_RR_OP( 7, sext_b, 0x80000070, 0xFFFFFF70, 0) //
TEST_RV32_RR_OP( 8, sext_b, 0x80000070, 0x80000070, 0) //

TEST_RV64_RR_OP( 1, sext_b, 0x7FFFFFFFFFFFFF90, 0x0000000000000090, 0)
TEST_RV64_RR_OP( 2, sext_b, 0x7FFFFFFFFFFFFF90, 0x7FFFFFFFFFFFFF90, 0)
TEST_RV64_RR_OP( 5, sext_b, 0x000000000000007F, 0x000000000000007F, 0)
TEST_RV64_RR_OP( 6, sext_b, 0x000000000000007F, 0x0FFFFFFFFFFFFF7F, 0)
TEST_RV64_RR_OP( 3, sext_b, 0xFFFFFFFFFFFFFF80, 0xF000000000000080, 0)
TEST_RV64_RR_OP( 4, sext_b, 0xFFFFFFFFFFFFFF80, 0xFFFFFFFFFFFFFF80, 0)
TEST_RV64_RR_OP( 7, sext_b, 0x8000000000000070, 0xFFFFFFFFFFFFFF70, 0)
TEST_RV64_RR_OP( 8, sext_b, 0x8000000000000070, 0x8000000000000070, 0)
