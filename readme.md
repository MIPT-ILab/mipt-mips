...
We use C++20 features and Boost 1.65.1. Thus, you have to [use compilers](https://github.com/MIPT-ILab/mipt-mips/wiki/C-compilers) of these versions or newer:
* GCC 9
* Clang 7.0.0
* Apple LLVM Version 10.0.0
* MS Visual Studio 2019 (Boost 1.66 is required)
